...
src/
  ...
  data/
    mockData.js          — auto-generated by scripts/extract_frontend_data.py
...
Source of truth: `data/all_restaurants.json` (29 MB, 520 Berlin restaurants).

Regeneration script: `scripts/extract_frontend_data.py`  
Run from the **project root** (`Nutrition App 2.0/`): `python3 scripts/extract_frontend_data.py`  
Writes output to `frontend/src/data/mockData.js`.
